(function($) {
    ...
    $.fn.fSelect = function(options) {
        ...
        fSelect.prototype = {
            create: function() {
                ...
                this.$select.before('<div class="fs-label-wrap"><div class="fs-label">' + this.settings.placeholder + '</div><span class="fs-arrow"><b></b></span></div>');
     ...
     * Events
     */
    $(document).on('click touchstart', '.fs-label, .fs-arrow', function() {
