...
var ESUtil = function () {
    ...
    return {
        anHienControl: function (arrTrangThai, obj) {
            ...
            var tthai = arrTrangThai.where(n => n.ma_doi_tac === obj.ma_doi_tac && n.ma_trang_thai === obj.ma_trang_thai).firstOrDefault();
            if (tthai === undefined || tthai === null || tthai.btn_hien==="") {
                return;
            }
            var arrControl = tthai.btn_hien.split(',');
