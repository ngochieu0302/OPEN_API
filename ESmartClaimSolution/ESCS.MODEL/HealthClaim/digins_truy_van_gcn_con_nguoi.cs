...
{
    public class digins_truy_van_gcn_con_nguoi
    {
        public string ma_doi_tac_nsd { get; set; }
        public string ma_chi_nhanh_nsd { get; set; }
        public List<digins_gcn_con_nguoi> gcn { get; set; }

        public List<digins_escs_gcn_con_nguoi> ConvertData()
        {
            var data = new List<digins_escs_gcn_con_nguoi>();
            if (this.gcn==null|| this.gcn.Count<=0)
                return data;
            foreach (var item in this.gcn)
            {
                digins_escs_gcn_con_nguoi escs_item = new digins_escs_gcn_con_nguoi();
                ...
                escs_item.ngay_sinh = item.ngay_sinh;
                ...
                escs_item.ma_goi_bh = item.ma_goi_bh;
                ...
                escs_item.goi_bh = item.goi_bh;
                data.Add(escs_item);
            }
            return data;
        }
    }
    public class digins_gcn_con_nguoi
    {
    ...
    public class digins_escs_gcn_con_nguoi
    {
